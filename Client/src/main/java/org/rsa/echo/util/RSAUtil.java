package main.java.org.rsa.echo.util;
...
public class RSAUtil {
	...
	public String encryptString(RSAKeyParameters publicKey, String plainText)
	...
	public String decryptString(RSAKeyParameters privateKey, String cipherText)
