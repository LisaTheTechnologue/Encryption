package main.java.org.secure.echo.util;
...
public class AESUtil {
	...
	public SecretKey getSecretKey() throws NoSuchAlgorithmException, InvalidKeySpecException, UnsupportedEncodingException{
		SecureRandom random = new SecureRandom();
		byte[] pass = random.generateSeed(IV_LENGTH);
		String password = new String(pass, "UTF-8");		
	...
	public SecretKey getSecretKey(byte[] key) throws NoSuchAlgorithmException, InvalidKeySpecException, UnsupportedEncodingException{
//		SecureRandom random = new SecureRandom();
//		byte[] decodedKey = Base64.decode(key);
//		String password = new String(pass, "UTF-8");		
//		SecretKeyFactory factory = SecretKeyFactory.getInstance("PBKDF2WithHmacSHA256");		
//		KeySpec spec = new PBEKeySpec(password.toCharArray(), SALT.getBytes(), 65536, KEY_LENGTH);
		SecretKey originalKey = new SecretKeySpec(key, ALGORITHM);
